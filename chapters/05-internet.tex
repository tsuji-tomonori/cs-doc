...
\chapterimage{ch05-internet.png}{異なる管理主体の網が複数の経路で相互接続する概念図。右側の木は階層的な名前解決を表します。}{fig:ch05-internet}
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[x=1mm,y=1mm,every node/.append style={font=\scriptsize}]
    \node[font=\sffamily\bfseries,text=DeepNavy] at (29,57) {OSI参照モデル};
    \node[font=\sffamily\bfseries,text=DeepNavy] at (93,57) {TCP/IPモデル};
    ...
    % 各層の高さを保ったまま対応先へ結び、線の収束と重なりを避けます。
    \draw[softflow] (54,51.5) -- (66,51.5);
    \draw[softflow] (54,43.5) -- (66,43.5);
    \draw[softflow] (54,35.5) -- (66,35.5);
    \draw[softflow] (54,27.5) -- (66,27.5);
    \draw[softflow] (54,19.5) -- (66,19.5);
    \draw[softflow] (54,11.5) -- (66,11.5);
    \draw[softflow] (54,3.5) -- (66,3.5);
  \end{tikzpicture}
...
\term{TTL}はTime to Liveの略で、DNS応答をキャッシュして再利用できる上限時間を秒数で示します。キャッシュ側はTTLが満了する前でも応答を破棄できますが、満了後の値をそのまま正しいものとして再利用してはいけません。
