...
\begin{learninggoals}
この章では、凝集度、結合度、情報隠蔽を変更の波及という観点から捉えます。インタフェースとモデルが何を示し、何を省くのかを判断し、オブジェクト指向と関数型の考え方を目的に応じて組み合わせます。最後に、具体的な変更要求を使って設計した境界とテストの妥当性を評価します。
\end{learninggoals}
