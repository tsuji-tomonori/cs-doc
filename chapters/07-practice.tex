...
\begin{learninggoals}
  \item Web要求を、コード、OS、メモリ、通信、アプリケーションの各層へ分解できます。
  \item 観測結果を、対応する層と資源へ結び付けて仮説を絞れます。
  \item 障害仮説を、反証に必要な観測と期待結果を含む形で記述できます。
  \item 担当する問題から、次に学ぶ分野と演習課題を選べます。
\end{learninggoals}


\section{一つのリクエストは、すべての階層を通ります}
...
\section{ソースコードは、命令列と実行時資源へ変換されます}
...
\section{要求は、通信の各層で包まれてサーバーへ届きます}
...
\section{アプリケーションは、入力を内部表現へ変えて処理します}
...
\section{処理中のデータには、置き場所と生存期間があります}
...
\section{観測結果を階層へ対応づけると、仮説を絞れます}
...
\section{処理が遅いときは、時間を分解して増え方を調べます}
...
\section{メモリを使いすぎるときは、量と生存期間を分けます}
...
\section{変更が難しいときは、変更理由と依存方向を見直します}
...
\section{AIの回答が安定しないときは、再現条件と評価集合を作ります}
...
\section{総合演習では、注文APIを端から端まで説明します}
...
\section{演習A：正常系の動作を、因果関係で図示します}
...
\section{演習B：四つの現象に、検証可能な調査計画を作ります}
...
\section{演習は、説明のつながりと検証可能性で評価します}
...
\section{終章の要点は、階層を越えて証拠をつなぐことです}
