...
新卒アプリケーションエンジニア向けに、情報工学の基礎を一冊の流れとして説明する技術書原稿です。
...
各章は、章の概要と到達目標から始まります。
本文は、定義、仕組み、成立条件、実務での観測方法を段落でつなぎ、図表を本文から参照する構成です。
章末には要点、確認問題、または手を動かす実習を置いています。

| 範囲 | 本文ページ | 主題 |
| --- | ---: | --- |
| はじめに | ii–iii | 本書の目的、対象読者、全体像、読み進め方 |
| 第1章 | 1–12 | 電気信号、2進表現、論理回路、記憶、CPU |
| 第2章 | 13–22 | 機械語、コンパイラ、AST、再帰、DFS、BFS |
| 第3章 | 23–36 | OS、仮想メモリ、型、計算量、配列、スライス、マップ |
| 第4章 | 37–50 | ソフトウェア危機、抽象化、モジュール、UML、設計原則 |
| 第5章 | 51–64 | 階層化、IP、DNS、TCP、UDP、QUIC、TLS、HTTP |
| 第6章 | 65–84 | 数学、回帰、分類、ニューラルネット、Transformer、LLM |
| 第7章 | 85–96 | 全階層の統合、障害調査、学習ガイド、総合演習 |
| 参考文献 | 97–101 | 大学教材、公式仕様、RFC、原著論文へのリンク |
...
- `tex/macros.tex`：章導入、到達目標、要点、出典の共通部品
- `assets/`：画像と生成記録
